...
向いている分野・転機のサインについて400〜500文字で鑑定してください。
温かく寄り添うトーンで、です・ます調で書いてください。
記号・箇条書き・見出しは使わず、ひと続きの文章で。`,
...
記号・箇条書き・見出しは使わず、ひと続きの文章で。`,
  ...
  sougou: PAID_PERSONA + `渡された命式・数霊データをもとに、この人の今の総合的な運気のバランス・
恋愛・仕事・財・時流がどう絡み合っているか・全体を整えるために意識するとよい視点について400〜500文字で鑑定してください。
温かく寄り添うトーンで、です・ます調で書いてください。
記号・箇条書き・見出しは使わず、ひと続きの文章で。`,
